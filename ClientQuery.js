define([
	...
	'dojo/_base/declare',
	'dojo/_base/array'
], function (StoreBase, declare, arrayUtil) {

	// module:
	//		dstore/ClientQuery
	// summary:
	//		Adds client side querying functionality
	...
	return declare(StoreBase, {
		...
		filter: function (filter) {
			return this.inherited(arguments)._defineQuerier(function (filter) {
		...
		map: function (query) {
			return this.inherited(arguments)._defineQuerier(function (query) {
				return function (data) {
		...
		sort: function (sorted) {
			return this.inherited(arguments)._defineQuerier(function (sorted) {
				return function (data) {
					data = data.slice();
