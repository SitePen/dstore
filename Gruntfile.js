...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		copy: {
			...
			staticJsFiles: {
				// TODO: remove this once fully converted to TypeScript
				expand: true,
				cwd: '.',
				src: [ 'src/**/*.js', 'tests/**/*.js' ],
				dest: '<%= devDirectory %>'
		...
		ts: {
			...
			dev: {
				// TODO: remove baseDir once there are ts files under src
				// (at which point it won't be needed, and it currently causes .baseDir.js to be generated)
				baseDir: './',
				outDir: '<%= devDirectory %>',
				src: [ '<%= all %>' ]
			},
	...
	// FIXME: This has not been updated/tested and likely will not work with mixed JS/TS currently
